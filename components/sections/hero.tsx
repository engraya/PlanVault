  ...
  return (
    <div className='w-full flex flex-col md:flex-row items-center justify-between p-16 pt-20 md:pt-40 gap-20 relative'>
      ...
      <div className='flex flex-col gap-2 z-10 md:max-w-80 lg:max-w-96'>
        <p className='text-slogan'>Effortless Payment & Subscription</p>
  ...
  <div className="mt-2">10X faster
    <span className="relative mt-3 whitespace-nowrap text-blue-600"><svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-3/4 left-0 right-0 m-auto h-[0.58em] w-fit fill-pink-400/50" preserveAspectRatio="none">
      ...
      <span className="relative">with PlanVault.</span>
        ...
        <p className='p mb-4 mt-4'>The all-in-one solution to handle subscriptions, payments, and billing effortlessly.</p>
